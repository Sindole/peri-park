...
.item .carousel-desc{text-align:center;}
...
.item4.active .carousel-img img.animated{visibility:visible; opacity:1; transition:all 1s ease; -webkit-transition:all 1s ease; -moz-transition:all 1s ease; -ms-transition:all 1s ease; -o-transition:all 1s ease;
animation-duration:2s; -webkit-animation-duration:2s; -moz-animation-duration:2s; -ms-animation-duration:2s; -o-animation-duration:2s; animation-delay:0.3s ; -webkit-animation-delay:0.3s;
-moz-animation-delay:0.3s;-ms-animation-delay:0.3s; }
.item .carousel-desc{text-align:center;}
.item  h2{font-size:50px; animation-delay:1.5s;animation-duration:1s; }
...
.item .fill{padding:0px 30px; display:table; }
.item .inner-content{display: table-cell;vertical-align: middle;}
.item6 .col-md-6{float:none; display:inline-block; vertical-align:middle; width:49%;}
...
{
	.item .carousel-desc , .item.item6 .carousel-desc{text-align:center;}
	.item .carousel-desc p {width:80%;}
	.item6 .col-md-6{width:100%; text-align:center;}
}
...
$(document).ready(function(){
	...
	// add animation type  from animate.css on the element which you want to animate
			...
			$('.item5 h2').animateCss('swing');
			$('.item5 p').animateCss('fadeIn');
			
			$('.item6 img').animateCss('fadeInLeft');
			$('.item6 h2').animateCss('fadeInDown');
                ...
                <!-- Wrapper for slides -->
                        ...
                        <div class="fill" style=" background-color:white;">
                            <div class="inner-content">
                                <div class="carousel-img">
                                   <a href="LedMonitors"><img src="images/cat-mn.jpg" alt="monitorscat" class="img img-responsive" /></a> 
                                </div>
                                <div class="carousel-desc">

                                    <h2 style="font-color:red;">Branded LCD & LED Monitors</h2>
                                    <p>We have high resolution, branded LCD & LED Monitors in this category. The worlds top class Monitors manufactures producing like
                                    Apple, DELL, Samsung, and ViewSonic brands sold here. They looks stylish and gives you the best picture quality in reasonable prices.</p>
                    ...
                    <div class="item item3">
                        <div class="fill" style="background-color:white;">
                            <div class="inner-content">
                                <div class="col-md-6">
                                    <div class="carousel-img">
                                        <img src="images/cat-cpu.jpg" alt="cat-cpu" class="img img-responsive" />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 text-left">
                                    <div class="carousel-desc">
                                        ...
                                        <h2>Assembled & Branded CPUs</h2>
                                        <p1>We have highly configuration-assembled & branded  CPUs in this category. The worlds top class CPU manufactures producing like
                                    Apple, DELL, HP brands and also high speed configuration-Assembled CPUs sold here. They looks amazing and has top-notch performance in best lowest prices.</p1>
                    ...
                    <div class="item item4">
                        <div class="fill" style=" background-color:white;">
                            <div class="inner-content">
                                ...
                                <div class="carousel-img">
                                    <img src="images/cat-lap.jpg" alt="sofa" class="img img-responsive" />
                                </div>
                                <div class="carousel-desc">

                                    <h2>Laptops</h2>
                                    <p>We have highly configuration-assembled & branded  CPUs in this category. The worlds top class CPU manufactures producing like
                                    Apple, DELL, HP brands and also high speed configuration-Assembled CPUs sold here. They looks amazing and has top-notch performance in best lowest prices.</p1>
 				...
 				<div class="item item2">
                        <div class="fill" style="background-color:white;">
                            <div class="inner-content">
                                <div class="carousel-img">
                                    <img src="images/cat-acc.jpg" alt="cat-acc" class="img img-responsive" />
                                </div>
                                <div class="carousel-desc">

                                    <h2>Peripherals for your dream Computer</h2>
                                    <p1>You can buy all kinds of computer accessories here in this category from various brands. We also have few imported and made in India accessories in lowest cost. We sell: Mouses, Keyboards, Speakers, headsets, Web-cams, UPS and other peripherals too.</p1>
                 ...
                 <div class="item item5">
                        <div class="fill" style="background-color:white;">
                            <div class="inner-content">
                                <div class="carousel-img">
                                    <img src="images/os-windows10.jpg" alt="cat-sw" class="img img-responsive" />
                                </div>
                                <div class="carousel-desc">

                                    <h2>Softwares & Operating Systems</h2>
                                    <p1>You can buy all kinds of computer accessories here in this category from various brands. We also have few imported and made in India accessories in lowest cost. We sell: Mouses, Keyboards, Speakers, headsets, Web-cams, UPS and other peripherals too.</p1>
                    ...
                    <div class="item item4">
                        <div class="fill" style="background-color:white;">
                            <div class="inner-content">
                                <div class="carousel-img">
                                    <img src="images/cat-hw.jpg" alt="cat-hw" class="img img-responsive" />
                                </div>
                                <div class="carousel-desc">

                                    <h2>Hardwares-CPU Interiors</h2>
